...
namespace ByContext.Tests
{
    public static class Extensions
    {
        ...
        public static Parameter FromExpression<TSection, TProperty>(this Parameter source,
                                                                    Expression<Func<TSection, TProperty>> selector)
        ...
        public static ParameterValue WithTextMatchReference(this ParameterValue source, string subjectName,
                                                            string subjectValue)
        {
            var condition = new FilterCondition
            {
                ConditionName = TextMatchCondition.Name,
                Properties = new Dictionary<string, string>
                        {
                            {"Subject", subjectName}, {"Value", subjectValue}
                        }
            };
            source.FilterConditions.Add(condition);
            return source;
        }
    }
}